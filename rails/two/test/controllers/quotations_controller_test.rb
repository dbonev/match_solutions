...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { created_at: @quotation.created_at, description: @quotation.description, project_id: @quotation.project_id }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { created_at: @quotation.created_at, description: @quotation.description, project_id: @quotation.project_id }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
